    ...
    return (
        <div className="min-h-screen bg-[#0A0A0C] flex items-center justify-center p-6">
            <div className="max-w-md w-full bg-[#141418] border border-red-500/20 rounded-2xl p-8 text-center space-y-4">
                ...
                <h2 className="text-lg font-bold text-white">Central de Leads travou</h2>
                <p className="text-sm text-white/40">
                    Um erro inesperado impediu o carregamento dos leads.
                    Isso pode ter sido causado por dados incompletos de migração.
                </p>
                <button
                    onClick={reset}
