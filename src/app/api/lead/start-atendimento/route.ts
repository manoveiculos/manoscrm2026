...
export async function POST(req: NextRequest) {
    try {
        ...
        if (hasAtendimento) {
            // (Throttle de 5min por captura REMOVIDO a pedido do dono — o vendedor
            // pode pegar quantos leads quiser da pesca. O claim atômico abaixo
            // continua impedindo que dois vendedores peguem o MESMO lead.)
